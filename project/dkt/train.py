#torch. It provides a flexible N-dimensional array or Tensor, which supports basic routines for indexing,
# slicing, transposing, type-casting, resizing, sharing storage and cloning
import torch
